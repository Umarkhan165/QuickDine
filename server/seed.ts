...
const seedData = async() => {
    try{
        ...
        const adminPassowrd = await bcrypt.hash("admin123",salt);
        ...
        const resturantData = [
            {
                ...
                avaliableSlots: ["18:00", "19:00", "20:00", "21:00", "22:00"],
                featured: true,
                exclusive: false,
            },
            {
                ...
                avaliableSlots: ["12:00", "13:00", "17:00", "18:00", "19:00", "20:00", "21:00"],
                featured: true,
                exclusive: false,
            },
            {
            ...
            },
            {
                ...
                avaliableSlots: ["11:30", "13:00", "14:30", "17:30", "19:00", "20:30"],
                featured: false,
                exclusive: false,
            },
            {
                ...
                avaliableSlots: ["17:00", "18:00", "19:00", "20:00", "21:00", "22:00"],
                featured: false,
                exclusive: false,
            },
            {
                ...
                avaliableSlots: ["17:00", "17:30", "18:00", "18:30", "19:00", "19:30", "20:00", "20:30", "21:00", "21:30"],
                featured: true,
                exclusive: true,
            },
            {
        ...
        const updatedResturantsData = resturantData.map((rest, idx)=>{
            const {...restInfo} = rest;
            return {
                ...restInfo,
                owner: ownerUser._id,
        ...
        console.log("Seeding Complete! Dissconnecting");

        await mongoose.disconnect();
        console.log("Dissconnected from Database");
